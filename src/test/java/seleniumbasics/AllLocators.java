...
//		implicit wait - 2 seconds time out
		...
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Onkar");
		...
		driver.findElement(By.xpath("//form/input[3]")).sendKeys("9822334455");
		...
		driver.findElement(By.cssSelector("#inputUsername")).sendKeys("Admin");
